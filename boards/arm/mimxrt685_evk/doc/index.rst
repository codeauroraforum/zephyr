...
.. tabs::
    ...
    .. group-tab:: LPCLink2 JLink Onboard
        ...
        3. Follow the instructions in :ref:`lpclink2-jlink-onboard-debug-probe` to program the J-Link firmware. Please make sure you have the latest firmware for this board.
    ...
    .. group-tab:: JLink External
        ...
        2. To disconnect the SWD signals from onboard debug circuit, **remove** jumpers J17, J18, J19 (these are installed by default).
